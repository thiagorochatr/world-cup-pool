...
export default function Home(props: HomeProps) {
  ...
  return (
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center'>
      <main>
        ...
        <form onSubmit={createPool} className='mt-10 flex gap-2'>
          <input
            ...
            value={poolTitle} />
          <button className='bg-ignite-400 py-4 px-6 rounded font-bold text-gray-900 text-sm uppercase hover:bg-ignite-600' 
      ...
      <Image src={appPreviewImg} alt="App Preview Image" quality={100}/>
    </div>
  )
}
